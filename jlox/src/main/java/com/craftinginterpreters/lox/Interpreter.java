...
public class Interpreter implements Expr.Visitor<Object>, Stmt.Visitor<Void> {
    ...
    public Void visitClassStmt(Stmt.Class stmt) {
        ...
        // if we have a superclass, bind its instance for lookup at runtime
        if (stmt.superclass != null) {
        ...
        LoxClass klass = new LoxClass(stmt.name.lexeme, (LoxClass) superclass, properties, methods, classMethods);

        // if we have a superclass we need to restore the previous environment
        if (superclass != null) {
